  ...
  return (
    <div className='flex justify-between p-10 sm:px-20 md:px-10 lg:px-20 xl:px-50'>
      ...
      <div className='w-100 items-center'>
        ...
        <p className='pt-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi, consequuntur vel vero architecto quod assumenda eum soluta veniam at ad.</p>
